...
// La fonction getStudentIdsSum prend en argument une liste d'étudiants (un tableau d'objets) et retourne la somme de tous les identifiants (attribut id).
// Elle utilise la fonction reduce pour réduire la liste à une seule valeur, qui est la somme des identifiants.
