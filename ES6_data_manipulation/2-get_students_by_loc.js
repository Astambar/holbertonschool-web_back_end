...
// La fonction getStudentsByLocation prend en argument une liste d'étudiants (un tableau d'objets)
// et une ville (une chaîne de caractères).
// Elle renvoie un nouveau tableau contenant
// uniquement les étudiants situés dans la ville spécifiée.
