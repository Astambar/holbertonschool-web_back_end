...
// La fonction updateStudentGradeByCity prend en argument une liste d'étudiants (un tableau d'objets),
// une ville (une chaîne de caractères) et une liste de nouvelles notes (un tableau d'objets).
// Elle retourne un nouveau tableau contenant les étudiants de la ville spécifiée avec leurs nouvelles notes mises à jour.
